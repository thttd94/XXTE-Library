...
function runStage2()
 ...
 while true do
  ...
  local xuliteCheckX, xuliteCheckY = screen.find_image(XULITE_IMG, 82, 0, 0, 750, 1334)
  if xuliteCheckX ~= -1 then
   everSeenXulite = true
...
function runStage3()
 ...
 if findImage(CHECK_BACKUPTTL, 82, 0, 0, 750, 1334) then
  ...
  swipeUpOnce()
  waitPhase(1000)
  waitTapImageForever(TAP_BACKUPTTL, "Tap BackupTTL", 82, 0, 0, 750, 1334)
 end
