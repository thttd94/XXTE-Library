...
SCRIPT_VERSION = tostring(SCRIPT_VERSION) .. "_TEST_S2S3"
phase("TEST Stage 2 + Stage 3")
waitPhase(1200)
local stage2Result = runStage2()
if stage2Result ~= true then failStatus("Lỗi Stage 2 TEST: " .. tostring(stage2Result)) end
if not runStage3() then failStatus("Lỗi Stage 3 TEST") end
phase("TEST S2+S3 DONE")
return true
